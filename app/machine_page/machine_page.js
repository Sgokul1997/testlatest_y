...
.controller('MachineCtrl', function($scope,$http,$location,$rootScope,$timeout,$window,$filter,$translate) {
...
console.log($rootScope.linechart_stoptime);
                         ...
                         $rootScope.lineChartExample = new Chart(LINECHARTEXMPLE, {
                              ...
                              data: {
                                  ...
                                  datasets: [
                                      {
                                  label: ($translate.instant('partsproduced')),
                                   fill: false,
                                  lineTension: 0.1,
                              ...
                              {
                                  label:($translate.instant('runtime')),  
                                  fill: true,             
                                  lineTension: 0.1,
                              ...
                              {
                                  label:($translate.instant('stoptime')),               
                                  fill: true,
                                   lineTension: 0.1,
