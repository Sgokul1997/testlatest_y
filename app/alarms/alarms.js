...
angular.module('alarms', ['ngRoute'])
  ...
  .controller('AlarmsCtrl', ['$scope', '$http', '$location', '$window', '$rootScope','$filter','$translate',
    function ($scope, $http, $location, $window, $rootScope,$filter,$translate) {
        ...
        if ($window.confirm("Please confirm?")) {
          $http.delete($rootScope.api_url + 'api/v1/alarms/' + id).success(function (data) {
            ...
            if (data) {
              ...
              alert($translate.instant('deletedsuccessfully'));
      ...
      $scope.alarmgenerate_report = function (gd, opid) {
        ...
        if ($rootScope.alarmwise == 'Operatorwise' && $scope.alarmoperator_id == undefined) {
          alert($translate.instant('pleaseselectoperator'));
          return;
        }
